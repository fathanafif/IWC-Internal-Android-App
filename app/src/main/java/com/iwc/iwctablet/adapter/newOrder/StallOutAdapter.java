...
public class StallOutAdapter extends RecyclerView.Adapter<StallOutAdapter.StallViewHolder> {

    Context context;
    ArrayList<Stalls> list;

    public StallOutAdapter(Context context, ArrayList<Stalls> list) {
    ...
    public void onBindViewHolder(@NonNull StallViewHolder holder, int position) {
        ...
        int converted = Integer.parseInt(stalls.getPrice_lk());
        ...
        dr.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    int itemPrice = Integer.parseInt(list.get(adapterPosition).getPrice_lk());
