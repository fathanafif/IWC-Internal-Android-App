...
public class BuffetItemOutAdapter extends RecyclerView.Adapter<BuffetItemOutAdapter.BuffetItemViewHolder> {

    Context context;
    ArrayList<BuffetItems> list;

    public BuffetItemOutAdapter(Context context, ArrayList<BuffetItems> list) {
    ...
    public void onBindViewHolder(@NonNull BuffetItemViewHolder holder, int position) {
        ...
        int converted = Integer.parseInt(buffetItems.getItem_price_lk());
        ...
        dr.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    int itemPrice = Integer.parseInt(list.get(adapterPosition).getItem_price_lk());
