...
public class BuffetPackOutAdapter extends RecyclerView.Adapter<BuffetPackOutAdapter.BuffetPackViewHolder> {

    Context context;
    ArrayList<Buffets> list;
    BuffetPackOutAdapter.BuffetPackItemClickListener mItemListener;

    public BuffetPackOutAdapter(Context context, ArrayList<Buffets> list, BuffetPackOutAdapter.BuffetPackItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(@NonNull BuffetPackViewHolder holder, int position) {
        ...
        converted = Integer.parseInt(buffets.getBuffet_price_lk());
        ...
        dr.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    int itemPrice = Integer.parseInt(list.get(adapterPosition).getBuffet_price_lk());
